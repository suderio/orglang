...
int main() {
    ...
    org_syscall(arena, org_op_infix(arena, ",", org_op_infix(arena, ",", org_op_infix(arena, ",", org_string_from_c(arena, "write"), org_int_from_str(arena, "1")), org_string_from_c(arena, "Hello from @sys!\n")), org_int_from_str(arena, "17")));
    org_malloc(arena, org_value_to_long(org_int_from_str(arena, "10")));
