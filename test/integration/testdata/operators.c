...
int main() {
    ...
    org_syscall(arena, org_op_infix(arena, ",", org_op_infix(arena, ",", org_op_infix(arena, ",", org_string_from_c(arena, "write"), org_int_from_str(arena, "1")), org_string_from_c(arena, "Dot Access:\n")), org_int_from_str(arena, "12")));
    org_call(arena, org_var_print, org_table_get(arena, org_list_make(arena, 3, org_int_from_str(arena, "10"), org_int_from_str(arena, "20"), org_int_from_str(arena, "30")), org_int_from_str(arena, "0")));
    org_syscall(arena, org_op_infix(arena, ",", org_op_infix(arena, ",", org_op_infix(arena, ",", org_string_from_c(arena, "write"), org_int_from_str(arena, "1")), org_string_from_c(arena, "Question Access:\n")), org_int_from_str(arena, "17")));
    org_call(arena, org_var_print, org_value_evaluate(arena, org_table_get(arena, org_list_make(arena, 3, org_int_from_str(arena, "10"), org_int_from_str(arena, "20"), org_int_from_str(arena, "30")), org_int_from_str(arena, "1"))));
