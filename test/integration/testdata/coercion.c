...
int main() {
    ...
    org_op_infix(arena, "->", org_op_infix(arena, "+", org_list_make(arena, 3, org_int_from_str(arena, "1"), org_int_from_str(arena, "2"), org_int_from_str(arena, "4")), org_int_from_str(arena, "1")), org_op_prefix(arena, "@", org_var_stdout));
    org_op_infix(arena, "->", org_op_infix(arena, ">", org_string_from_c(arena, "test"), org_bool(arena, 1)), org_op_prefix(arena, "@", org_var_stdout));
