...
return org_op_infix(arena, "+", right, org_string_from_c(arena, "!"));
}
...
int main() {
    ...
    org_op_infix(arena, "->", org_op_infix(arena, "->", org_op_prefix(arena, "@", org_var_stdin), org_func_create(arena, org_fn_4)), org_op_prefix(arena, "@", org_var_stdout));
